...
class StickmanGenerator:
    ...
    def generate(
        ...
        preferred_opening_template: str | None = None,
    ):
        ...
        report(5, "开始生成火柴人视频")
        script_data = self.generate_script_data(topic, storyboard_count, preferred_opening_template)
        report(20, "脚本生成完成")
    ...
    def generate_script_data(self, topic: str, storyboard_count: int, preferred_opening_template: str | None = None):
