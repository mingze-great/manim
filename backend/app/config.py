...
class Settings(BaseSettings):
    ...
    DASHSCOPE_MODELS: str = "MiniMax-M2.5,deepseek-v3.2,glm-5,qwen3-coder-next,kimi-k2-thinking"
    DASHSCOPE_CHAT_MODEL: str = "qwen-plus"
    DASHSCOPE_CODE_MODEL: str = "MiniMax-M2.5"
    DASHSCOPE_AVAILABLE_MODELS: str = "MiniMax-M2.5,deepseek-v3.2,glm-5,qwen3-coder-next,kimi-k2-thinking"
