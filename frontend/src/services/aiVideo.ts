...
export const aiVideoApi = {
  ...
  applyEdit: (id: number, editPlan: string[], message?: string) => api.post<{ versionId: number; versionNo: number; jobId: string; project: AiVideoProject }>(`/ai-video/projects/${id}/apply-edit`, { editPlan, message }),
