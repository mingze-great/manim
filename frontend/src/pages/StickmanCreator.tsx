...
• 熬夜对身体的真实影响`}
                ...
                <div className="audio-source-box">
                  ...
                  {voiceSource !== 'ai' && (
                    <>
                      <div className="audio-source-box" style={{ marginTop: 14 }}>
                ...
                <div className="stickman-upload-grid">
                  <div className="audio-source-box" style={{ marginTop: 0 }}>
                    ...
                    {backgroundImagePreviewUrl && <img src={backgroundImagePreviewUrl} alt="background-preview" className="stickman-preview-image" />}
                  </div>
              ...
              <div className="stickman-side-stack stickman-side-sticky">
                <div className="stickman-side-card">
                  ...
                  <div className="stickman-side-meta">
                    ...
                    <Tag color={stickmanVariant === 'v2' ? 'gold' : 'blue'}>{stickmanVariant === 'v2' ? '增强讲解' : '标准讲解'}</Tag>
                  </div>
                  ...
                  <div className="stickman-side-section" style={{ marginTop: 12 }}>
                    ...
                    {voiceSource === 'ai' && (
                      <div className="stickman-compact-grid" style={{ marginTop: 12 }}>
                        <div>
