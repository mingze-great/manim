...
import ArticleRenderedContent from './ArticleRenderedContent'
...
export default function PhonePreview({ article, htmlContent }: PhonePreviewProps) {
        ...
        >
          ...
          >
            {(htmlContent || article?.content_html) ? (
              <ArticleRenderedContent html={htmlContent || article?.content_html || ''} />
            ) : (
              <div 
                style={{ 
                  display: 'flex', 
